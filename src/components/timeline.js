export const timelineEvents = [
    ...
    events: [
      ...
      },
      {
        ...
        * worked on the frontend of the Dolomite web app, interfacing with the web3j driven backend to create the Order Fills Page, along with developing other features.
        \n
        software engineer @ ecomedes / lehigh@nasdaq
        * restructured components of backend & frontend by updating a legacy version of React in order to more easily represent information about the 700,000+ product & 10,000+ brand filled PostgreSQL database.
        \n
        ...
        * interned with the Sony Research & Development team, developing a full-stack web app to enable students to tour colleges during the COVID-19 pandemic.
        ...
        { name: 'ecomedes', link: 'https://ecomedes.com/' },
        { name: 'lehigh@nasdaq', link: 'https://nasdaqcenter.lehigh.edu/' },
  ...
  },
  {
    ...
    events: [
        {
        year: '2024',
        description: 'begin M.S. in Applied & Computational Mathematics at Johns Hopkins',
        fullTimeline: 'august 2024',
        details: `
        commencing coursework at Johns Hopkins Whiting School of Engineering to attain richer understanding of the math which comprises contemporary machine learning.
        `,
        organizations: [
        { name: 'engineering.jhu.edu', link: 'https://ep.jhu.edu/programs/applied-and-computational-mathematics/' }, 
        ]
        },
        {
        year: '2022',
      ...
      },
      {
        ...
        * Design of Integrated Business Applications I & II
        `,
        organizations: [
